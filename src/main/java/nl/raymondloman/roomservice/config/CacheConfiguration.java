package nl.raymondloman.roomservice.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(nl.raymondloman.roomservice.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(nl.raymondloman.roomservice.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(nl.raymondloman.roomservice.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(nl.raymondloman.roomservice.domain.Authority.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(nl.raymondloman.roomservice.domain.Room.class.getName() + ".tasks", jcacheConfiguration);
